...
public final class MesheliumCpuStages {
    ...
    private static boolean resolveArmed() {
        ...
        // The SCENE property, deliberately, rather than
        // MesheliumBenchRecorder.ARMED. Since the far-armed bench
        // (-Pmeshelium.farbench) arms that recorder too, reading it here
        // would silently put seven nanoTime pairs a frame into a run
        // whose whole output is a frame-time distribution. The near-field
        // benchmark keeps the stage rows it has always had for free;
        // -Pmeshelium.cpustages=true still arms them anywhere.
        return System.getProperty(MesheliumBenchRecorder.PROPERTY) != null;
    }
