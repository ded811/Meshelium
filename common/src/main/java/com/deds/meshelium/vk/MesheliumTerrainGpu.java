...
public final class MesheliumTerrainGpu implements TerrainGpuHost {
    ...
    private static void releasePartialStandup(long vma, VkArenaBacking arenaBacking,
            ...
            MesheliumVkBuffers.DeviceBuffer sectionBuffer, VkStagingRing ring) {
        MesheliumLog.LOGGER.warn("Meshelium terrain standup failed part-way - releasing "
        ...
        try {
            ...
            MesheliumLog.LOGGER.warn("Meshelium: arena backing release failed during unwind", t);
        }
        for (MesheliumVkBuffers.DeviceBuffer b : new MesheliumVkBuffers.DeviceBuffer[] {
            ...
            try {
                ...
                MesheliumLog.LOGGER.warn("Meshelium: record buffer release failed during unwind", t);
            }
        }
        if (ring != null) {
            try {
                ...
                MesheliumLog.LOGGER.warn("Meshelium: staging ring release failed during unwind", t);
            }
        }
    }
