...
import com.deds.meshelium.mixin.OptionInstanceAccessor;
...
public final class MesheliumExtendedRd {
    ...
    public static void init() {
        MesheliumPlatform.onEndClientTick(MesheliumExtendedRd::onEndTick);
    }
    ...
    private static void widenChunkTaskLadder(int extraChunks) {
        ...
        ladderWidened = true;
        int base = com.deds.meshelium.mixin.ChunkTaskPriorityQueueAccessor
                .meshelium$priorityLevelCount();
        com.deds.meshelium.mixin.ChunkTaskPriorityQueueAccessor
    ...
    public static int chunkTaskLadderRungs() {
        return com.deds.meshelium.mixin.ChunkTaskPriorityQueueAccessor
                .meshelium$priorityLevelCount();
    }
