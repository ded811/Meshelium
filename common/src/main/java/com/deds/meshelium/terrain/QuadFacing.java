 ...
 * relChunk.x ≤ 0.) The POS_X, POS_Y, POS_Z, NEG_X, NEG_Y, NEG_Z,
 * UNASSIGNED order is OURS and is defined here: our encoder fills the
 * buckets and this enum plus the GLSL above are the whole contract, so
 * nothing outside this repository constrains it.</p>
 */
