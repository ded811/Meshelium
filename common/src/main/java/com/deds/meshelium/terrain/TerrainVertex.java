 ...
 * the upstream mesher Nvidium builds on (Nvidium's compat package,
 * NvidiumCompactChunkVertex.java:53-62), made host-agnostic: primitives
 * only, no vanilla, host-mesher or LWJGL types.
 */
 ...
 *          (upstream mesh space — see {@link TerrainVertexCodec} assumptions)
 * @param y as x
 * @param z as x
