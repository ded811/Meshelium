 ...
 *       16-px lightmap at {@code v/256}). NAMED ASSUMPTION: the upstream
 ...
 * This deviates from Nvidium's material mapping (translucent was cutoff 0
 * there) because our source data is vanilla's own render pipelines; wave 7
 * revisits when the translucent shader lands.
 */
